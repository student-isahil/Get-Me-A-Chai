...
function App() {
  ...
  const showPassword = () => {
    if (ref.current.src.includes("https://res.cloudinary.com/darj9wemb/image/upload/v1747244508/eyecross_lp7iju.png")) {
      ref.current.src = "https://res.cloudinary.com/darj9wemb/image/upload/v1747244508/eye_soonip.png"
      passwordRef.current.type = "password"
    }
    else {
      passwordRef.current.type = "text"
      ref.current.src = "https://res.cloudinary.com/darj9wemb/image/upload/v1747244508/eyecross_lp7iju.png"
    }
            ...
            <div className="flex flex-col md:flex-row w-full justify-between gap-8">
              ...
              <div className="relative">
                ...
                <span className='absolute right-[3px] top-[4px] cursor-pointer' onClick={showPassword}>
                  <img id='eyeicon' ref={ref} className='p-1' width={26} src="https://res.cloudinary.com/darj9wemb/image/upload/v1747244508/eye_soonip.png" alt="eye" />
                </span>
              </div>
